					...
					<div class="img" style="height: 275px;">
						<a href="#">
							 <?php if($product['thumbnail']) { ?>
                                  <img src="admin/<?php echo $product['thumbnail']?>" alt="foody-albummax_.jpg" style="width:500px;height: 275px;border:0;">
                                  <?php } else { ?>
						...
						<div class="prof-photos-items">
							...
							<div class="microsite-professional-photo-item">
								<a href="detail-menu.php?menu_id=<?php echo $row['id'] ?>">
									...
									<img src="admin/<?php echo $row['thumbnail']?>" alt="foody-albummax_.jpg" style="height:150px;width:100%;"">
									<?php } else { ?>
